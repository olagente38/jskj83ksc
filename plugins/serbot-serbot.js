  ...
  exec(_0x5e8ff0.toString("utf-8"), async (_0x467fe3, _0x4c69b8, _0x301f58) => {
    ...
    async function _0x5c4c72() {
      ...
      const _0x5cce4d = {
        ...
        'browser': _0x4ea9f2 ? ["Ubuntu", "Chrome", "110.0.5585.95"] : ["Mizuki-Ai (Sub Bot)", "Chrome", '2.0.0'],
...
handler.help = ['serbotmizuki', "serbotmizuki code"];
handler.tags = ['serbotmizuki'];
handler.command = ["jadibotmizuki", "serbotmizuki"];
